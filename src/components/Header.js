  ...
  return (
    <header className="header">
      ...
      {user ? (
        ...
        <Link onClick={handleSignOut} style={{fontSize:"x-large", display:'flex', marginRight:"10px", color:"#444444", marginTop:"auto", marginBottom:"auto", marginLeft:"15px", textDecoration:"none"}}><FaArrowRightFromBracket /></Link>
        </>
      ) : (
